...
const fechaCronSegDel = async (req, res) => {
  ...
  } else if (req.body.progId.length > 0) {
    for (let i = 0; i < prog.fechasCron.length; i++) {
      const fecha = prog.fechasCron[i];
      enero = fecha.enero;
      febrero = fecha.febrero;
      marzo = fecha.marzo;
      abril = fecha.abril;
      mayo = fecha.mayo;
      junio = fecha.junio;
      julio = fecha.julio;
      agosto = fecha.agosto;
      septiembre = fecha.septiembre;
      octubre = fecha.octubre;
      noviembre = fecha.noviembre;
      diciembre = fecha.diciembre;
      anio = fecha.anio;
...
exports.fechaCronSegDel = onRequest({
